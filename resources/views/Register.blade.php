            ...
            <div>
                ...
                <form method="post" action="/Register.blade.php">
                    ...
                    <div class="d-flex justify-content-end">
                        <input type="password" name="password" class="form-control mb-3" id="PasswordInput" placeholder="Password" maxlength="20" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                        <i class="bi bi-eye-slash mt-1 me-3" style="position: absolute;" id="togglePassword"></i>
                    </div>
                    <div class="d-flex justify-content-end">
                        <input type="password" name="password" class="form-control mb-3" id="PasswordInput2" placeholder="Confirm Password" maxlength="20">
                        <i class="bi bi-eye-slash mt-1 me-3" style="position: absolute;" id="togglePassword2"></i>
                    </div>
                    <button type="submit" class="btn btnLogin w-100 mb-3" style="font-family: 'Open Sans', sans-serif;">Register</button>
                </form>
