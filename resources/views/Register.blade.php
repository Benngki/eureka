...
<body>
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center mt-5">
            <img style="width: 60%" src="{{asset('asset/RegisterImg.png')}}"  alt="">
            <div>
                ...
                <form method="post">
                    ...
                    <div class="d-flex justify-content-end">
                        <input type="password" name="password" class="form-control mb-3" id="PasswordInput" placeholder="Confirm Password" maxlength="12">
                        <i class="bi bi-eye-slash mt-1 me-3" style="position: absolute;" id="togglePassword"></i>
                    </div>
                    <button type="button" class="btn btnLogin w-100 mb-3" style="">Register</button>
                </form>
