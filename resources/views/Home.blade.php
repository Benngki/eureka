...
<body>
    <nav class="navbar navbar-expand-lg bg-body-secondary">
        <div class="container-fluid">
          <a class="navbar-brand ms-5" href="#"><img style="width: 80%;"  src="{{asset('asset/logo.svg')}}" alt="Logo Dialog Diri"></a>
            ...
            <ul class="navbar-nav justify-content-end nav-fill nav-underline align-items-baseline">
              ...
              <li class="nav-item">
                <a class="nav-link linkNav" href="#">Chatbot</a>
              </li>
              <li class="nav-item">
              ...
              <button type="button" class="btn me-5" ><img class="mx-1"  src="{{asset('asset/profile.png')}}" alt="">Login</button>
            </ul>
        </div>
      </nav>
      ...
      <div class="container-fluid" style="margin-bottom: 8rem;">
        <div class="d-flex justify-content-evenly align-items-center">
            ...
            <img class="animationGmbr1" data-aos="fade-left" style="min-width: 40%;"  src="{{asset('asset/Home1.png')}}" alt="">
        </div>
      </div>
      ...
      <div class="container-fluid rounded-top-5  "  style="background: #A3C7A7; ">
        <div class="d-flex justify-content-evenly js-scroll fade-in">
          ...
          <div class="card rounded-4 " style="border: none; width: 20%; margin-top: -1rem; background-color: #48904F;color: white;">
              <div class="card-body">
                  <img class="cardimg"  src="{{asset('asset/card1.png')}}" alt="">
            ...
            <div class="card rounded-4" style="border: none; width: 20%; margin-top: -1rem;background-color: #48904F;color: white">
                <div class="card-body">
                    <img class="cardimg "  src="{{asset('asset/card2.png')}}" alt="">
            ...
            <div class="card rounded-4" style="border: none; width: 20%; margin-top: -1rem;background-color: #48904F;color: white">
                <div class="card-body">
                    <img class="cardimg"  src="{{asset('asset/card3.png')}}" alt="">
          ...
          <div class="card text-center mb-3 rounded-4" style="width: 90vw; background-color: #FCF4F0;">
            <div class="card-body ">
              ...
              <div class="d-flex justify-content-evenly ">
                  ...
                  <div style="width: 20vw;">
                    <img style="width:15vw ;"  src="{{asset('asset/Fitur1.png')}}" alt="">
                  ...
                  <div style="width: 20vw;">
                    <img style="width:15vw ;"  src="{{asset('asset/Fitur2.png')}}" alt="">
      ...
      <div class="container-fluid d-flex justify-content-evenly px-5 pt-5" style="background-color: #E3F2FF;">
        <img style="width: 25%;"  src="{{asset('asset/Home2.svg')}}" alt="">
              ...
              <div class="d-flex justify-content-evenly p-3">
                ...
                <div class="card w-25 rounded-4 py-3" style="background-color: #FCF4F0;border: none; box-shadow: 0px 2px 10px 3px rgba(0,0,0,0.15);">
                  <div class="card-body d-flex justify-content-center align-items-center">
                    <img style="width:50%;"  src="{{asset('asset/profile.png')}}" alt="">
      ...
      <div class="container-fluid d-flex justify-content-between p-5" style="background-color: #A3C7A7;">
        <div style="width: 40vw;">
          <img class="mb-3"  src="{{asset('asset/logo.svg')}}" alt="">
        ...
        <div style="width: 30vw;">
          ...
          <div class="d-flex justify-content-start">
            <a class="me-3" href=""><img  src="{{asset('asset/IG.svg')}}" alt=""></a>
            <a href=""><img src="{{asset('asset/WA.svg')}}" alt=""></a>
            <a class="ms-3" href=""><img  src="{{asset('asset/Twitter.svg')}}" alt=""></a>
          </div>
        </div>
      </div>
