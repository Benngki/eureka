    ...
    <div class="col-11 offset-1 d-flex flex-column vh-100 justify-content-center">
      <div class="cotainer d-flex flex-column align-items-center">
          ...
          <div class="d-flex justify-content-center align-self-stretch ">
              <img style=" width: 30%;" class="Dialogdirir" alt="" src="{{ asset('img/image 16.png') }}" />
          </div>
            <p class="mt-3 Opensans m-0 text-center"> Hasil tes menunjukkan bahwa tingkat stres Anda saat ini berada 
                                                 ...
                                                 <br> masalah-masalah yang sedang dihadapi.</p>
