    ...
    <div class="col-11 offset-1 d-flex flex-column vh-100 justify-content-center">
      <div class="cotainer d-flex flex-column align-items-center">
          ...
          <div class="d-flex justify-content-center align-self-stretch ">
              <img style=" width: 20%;" class="Dialogdirir" alt="" src="{{ asset('img/4435116.jpg') }}" />
          </div>
            <p class="mt-3 Opensans m-0 text-center"> Hasil tes menunjukkan bahwa tingkat stres Anda saat ini pada tingkat <b>Antisosial,</b>
                                                ...
                                                <br> memilih untuk menjaga jarak dari situasi sosial.</p>
