    ...
    <nav class="navbar navbar-expand-lg bg-body-secondary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav nav-fill nav-underline align-items-baseline">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a wire:navigate href="{{ route('login') }}" role="button" type="button" class="btn me-5 "><img
                                class="mx-1 TMD " src="{{asset('img/profile.png')}}" alt=""> Masuk</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid container-lg overflow-hidden" style="margin-bottom: 13rem;">
      <div class="row align-items-center ">
          <div class="col-lg-7 col-12 order-lg-1 order-0"> <!-- Tambahkan kelas col-lg-7 di sini -->
              <img class="animationGmbr1" data-aos="fade-left" style="width: 100%; min-width: 40%;" src="{{asset('img/Home1.png')}}" alt="">
          </div>
          <div class="col-lg-5 col-12 order-lg-0 order-1"> <!-- Tambahkan kelas col-lg-5 di sini -->
            <div class="animationTeks1" id="">
              <h2 class="TMD"><b>Berani Bicara,<br>Berani Berubah</b></h2>
              <p class=" fs-5" >
              ...
              <button type="button" class="btn rounded-5 btn-lg px-5 mt-5 Buttonhover TMD" style="background: #48904F; color: white;">Mulai</button>
          </div>
      </div>
  </div>
            ...
            <div class="card-body ">
              ...
              <div class="d-flex justify-content-evenly ">
                  ...
                  <div style="width: 20vw;">
                    ...
                    <p class=""> <b>Tes Psikologi</b> adalah suatu alat yang digunakan untuk mengukur dan mengevaluasi berbagai aspek psikologis seseorang. Tes ini dirancang untuk memberikan gambaran tentang karakteristik, kepribadian, kemampuan kognitif, minat, dan perilaku individu.</p>
                  </div>

                  <div style="width: 20vw;">
                    <img style="width:15vw ;"  src="{{asset('img/Fitur2.png')}}" alt="">
                    <h5 class="fw-bolder TMD ">Chatbot</h5>
                    <p class=""> <b>Chatbot</b> adalah suatu layanan yang disediakan untuk membantu pengguna untuk memberikan pertanyaan mengenai kesehatan mental, dengan adanya chatbot dapat memberikan jawaban yang cepat dan akurat.</p>
                  </div>
      ...
      <div class="container-fluid d-flex justify-content-evenly px-5 pt-5" style="background-color: #E3F2FF;">
        ...
        <div class="d-flex align-items-center w-50">
          <div style="text-align: end;">
            <h2 class="js-scroll slide-right TMD" >Masalah kesehatan mental meningkat hingga 300 juta orang seluruh dunia menderita gangguan kecemasan hingga depresi</h2>
            ...
            <div style="text-align: center;">
              <a href="{{ route('test') }}" type="button" class="btn rounded-5 Buttonhover TMD" style="padding-left: 6rem;padding-right: 6rem; background: #48904F; color: white;">Mulai Test</a>
            </div>
          </div>
        </div>
      </div>
      <div class="container-fluid mt-5 overflow-hidden">
        <h3 class="mb-5 fw-bolder js-scroll slide-left TMD" style="margin-left: 6rem;">Kata Mereka Tentang Kami...</h3>
      ...
      <div id='kontak' class="container-fluid d-flex justify-content-between p-5" style="background-color: #A3C7A7;">
        <div style="width: 40vw;">
          ...
          <p class="">DialogDiri adalah sebuah platform daring yang bertujuan untuk memberikan dukungan dan bantuan bagi individu yang mengalami tantangan kesehatan mental. Platform ini dirancang untuk menciptakan ruang aman bagi penggunanya untuk berbicara tentang perasaan, emosi, dan pengalaman yang terkait dengan kesehatan mental mereka.</p>
        </div>
