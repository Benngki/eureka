...
<body>
    <header>
                        ...
                        <li class="nav-item">
                            ...
                            @guest
                                <a wire:navigate href="{{ route('login') }}" role="button" type="button"
                                    class="btn me-5 "><img class="mx-1 TMD " src="{{ asset('img/profile.png') }}"
                                        alt=""> Masuk</a>
                            @endguest
        ...
        <div class="container-fluid container-lg overflow-hidden" style="margin-bottom: 13rem;">
            <div class="row align-items-center ">
                ...
                <div class="col-lg-5 col-12 order-lg-0 order-1"> <!-- Tambahkan kelas col-lg-5 di sini -->
                    ...
                    <button type="button" class="btn rounded-5 btn-lg px-5 mt-5 Buttonhover TMD"
        ...
        <div class="container-fluid rounded-top-5  " style="background: #A3C7A7; ">
            <div class="d-flex justify-content-evenly js-scroll fade-in">
                ...
                <div class="card rounded-4 "
                    style="border: none; width: 20%; margin-top: -1rem; background-color: #48904F;color: white;">
                    <div class="card-body">
                ...
                <div class="card rounded-4"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text ">2,6 persen yang mengakses layanan konseling, baik emosi maupun perilaku.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center w-50">
                <div style="text-align: end;">
                    ...
                    <div style="text-align: center;">
                        <a href="{{ route('test') }}" type="button" class="btn rounded-5 Buttonhover TMD"
                            style="padding-left: 6rem;padding-right: 6rem; background: #48904F; color: white;">Mulai
                            Test</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid mt-5 overflow-hidden">
            <h3 class="mb-5 fw-bolder js-scroll slide-left TMD" style="margin-left: 6rem;">Kata Mereka Tentang Kami...
            </h3>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-evenly p-3">
                            <div class="card w-25 rounded-4 py-3"
                                ...
                                <div class="card-body d-flex justify-content-center align-items-center">
                                    <img style="width:50%;" src="{{ asset('img/profile.png') }}" alt="">
                                    <p class="card-text ps-4">“Menarik, Bagus, sangat membantu saya dalam mengenal diri
                                        sendiri”</p>
                                </div>
                            </div>
        ...
        <div class="mt-5 container-fluid bg-danger d-flex justify-content-center ">
            <p style="margin:0px;color: white; "><b>Peringatan</b><i> jika Anda sedang mengalami krisis psikologis yang
                    mengancam hidup Anda, layanan ini tidak direkomendasikan untuk Anda. Silahkan menghubungi 119</i>
            </p>
        </div>

        <div id='kontak' class="container-fluid d-flex justify-content-between p-5"
            style="background-color: #A3C7A7;">
            <div style="width: 40vw;">
                <img class="mb-3" src="{{ asset('img/logo.svg') }}" alt="">
                <p class="">DialogDiri adalah sebuah platform daring yang bertujuan untuk memberikan dukungan dan
                    ...
                    terkait dengan kesehatan mental mereka.</p>
            </div>
